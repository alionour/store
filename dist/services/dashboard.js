...
var DashboardQueries = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT products.name, products.price, orders.id FROM products\n       INNER JOIN orders ON producta.id = orders.product_id ;";
                        return [4 /*yield*/, conn.query(sql)];
                    case 2:
                        result = _a.sent();
                        conn.release();
    ...
    * @memberof OrderStore
    */
    DashboardQueries.prototype.topProducts = function (limit) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
