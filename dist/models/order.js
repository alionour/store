...
var OrderStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "INSERT INTO orders (product_id,quantity, user_id,status)\n       VALUES($1, $2, $3,$4) RETURNING *";
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not add new order ".concat(o.product_id, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
     ...
     * @memberof OrderStore
     */
    OrderStore.prototype.showOrdersByUserId = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @memberof OrderStore
     */
    OrderStore.prototype.showCompletedOrdersByUserId = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @memberof OrderStore
     */
    OrderStore.prototype.showActiveOrdersByUserId = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
