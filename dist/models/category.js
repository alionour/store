...
var CategoryStore = /** @class */ (function () {
     ...
     */
    CategoryStore.prototype.index = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not find category ".concat(id, ". Error: ").concat(err_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
     ...
     * @memberof CategoryStore
     */
    CategoryStore.prototype.create = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, category, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not add new category ".concat(p.category, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
     ...
     * @memberof CategoryStore
     */
    CategoryStore.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, category, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not delete category ".concat(id, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
