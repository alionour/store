...
var compare_hash_1 = require("../utils/compare_hash");
...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.login = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, user, isValid, token, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        ...
                        if (result.rowCount > 0) {
                            user = result.rows[0];
                            isValid = (0, compare_hash_1.compareHash)(password, user.password);
                            if (isValid) {
                                token = (0, create_token_1.generateToken)(user);
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("username or password is invalid ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
     ...
     * @memberof UserStore
     */
    UserStore.prototype.signUp = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, user, token, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "INSERT INTO users (firstname, email,lastname,password)\n       VALUES($1, $2, $3,$4) RETURNING *";
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not add new user ".concat(u.firstname, ".\n       Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
