    ...
    AuthenticationController.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    token = AuthenticationController.store.login(req.body.email, req.body.password);
                    res.json(token);
                }
                catch (error) {
                    throw new Error("can not login in ".concat(error));
                }
                return [2 /*return*/];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    token = AuthenticationController.store.signUp(u);
                    res.json(token);
                }
                catch (error) {
                    throw new Error("can not sign up in ".concat(error));
                }
                return [2 /*return*/];
            });
        });
